...
$string['subjectidentifierrequirements'] = 'Requirements Signaling for Subject Identifier Attributes';
$string['subjectidentifierrequirements_help'] = 'Requirements signaling according to {$a} for Subject Identifier Attributes.';
