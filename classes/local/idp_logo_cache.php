...
/**
 * Class that contains helpers for locally caching remote idp logos.
 *
 * @package    auth_saml2
...
class idp_logo_cache {
    /**
     * The component a logo belongs to.
     *
     * @var string
     */
    public const COMPONENT = 'auth_saml2';

    /**
     * The filearea for logos.
     *
     * @var string
     */
    public const FILEAREA = 'idplogo';

    /**
     * The filepath for idp logos.
     *
     * @var string
     */
